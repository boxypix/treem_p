// t_b2c.js — база B2C метрик (#b2c)

window.T_B2C = {
  id: "root",
  code: "B2C",
  name: "B2C дерево метрик",
  short:
    "Карта метрик B2C: от ценности (NSM) и воронки до удержания, денег, качества и экономики.",
  why:
    "Помогает быстро диагностировать, где ломается рост (привлечение, активация, использование, удержание, монетизация, качество или юнит-экономика) и какие рычаги реально на это влияют.",
  tags: ["framework", "b2c"],
  howImprove: [
    ...
    "Назначь владельца метрики и целевой диапазон (что считаем успехом) на 2–4 недели",
    "Проверяй динамику и когорты (канал/страна/версия/сегмент), а не только среднее"
  ],
  pitfalls: [
    ...
    "Нет единого определения/окна подсчета → разные люди считают по-разному",
    "Смотреть метрику без контекста (сезонность, релизы, каналы) и делать ложные выводы"
  ],
  ...
  children: [
    {
      ...
      short:
        "Главная метрика ценности: показывает, что пользователь регулярно получает ключевую пользу.",
      why:
        "Держит команду в фокусе на пользе, а не на объеме. Если растут прокси-метрики, а NSM нет — продукт не стал полезнее.",
      formula:
...

    {
      id: "acq",
      code: "ACQ",
      name: "Привлечение (Acquisition)",
      short: "Как люди узнают о продукте и доходят до установки.",
      why:
        "Определяет масштаб и качество входящего потока. Плохое качество трафика убивает активацию, удержание и LTV ниже по воронке.",
...

    {
      id: "act",
      code: "ACT",
      name: "Активация (Activation / First Value)",
      short: "Случилась ли у новичка первая реальная польза и как быстро.",
      why:
        "Это главный “узкий горлышко” для роста: без first value не спасут ни ремаркетинг, ни пуши, ни paywall.",
      tags: ["onboarding", "aha"],
      howImprove: [
...

    {
      id: "eng",
      code: "ENG",
      name: "Использование (Engagement)",
      short: "Насколько регулярно пользователи делают действия, которые приносят пользу.",
      why:
        "Engagement показывает повторяемость ценности. Без регулярных полезных действий удержание и выручка не удержатся.",
      tags: ["usage"],
      howImprove: [
...

    {
      ...
      why:
        "Retention — прямой индикатор ценности во времени. Если он низкий, вы льете трафик в “дырявое ведро”.",
      tags: ["cohorts"],
      howImprove: [
...

    {
      id: "mon",
      code: "MON",
      name: "Монетизация (Monetization)",
      short: "Как продукт конвертирует ценность в деньги: подписки, покупки, реклама.",
      why:
        "Монетизация должна усиливать ценность, а не ломать ее. Слишком ранний/агрессивный paywall ухудшает активацию, удержание и рейтинг.",
      tags: ["revenue"],
      howImprove: [
...

    {
      id: "qual",
      code: "QUAL",
      name: "Качество (Quality & Reliability)",
      short: "Стабильность и скорость: как часто продукт падает, тормозит и раздражает.",
      why:
        "Качество напрямую бьет по активации, удержанию, оплатам и отзывам. Это не “техдолг”, а драйвер роста.",
...

    {
      id: "ue",
      code: "UE",
      name: "Экономика (Unit Economics)",
      short:
        "Экономика роста: можно ли масштабироваться прибыльно и устойчиво.",
      why:
        "Красивые метрики воронки не важны, если LTV/CAC и payback не сходятся — вы просто сжигаете деньги и время.",
      tags: ["finance"],
      howImprove: [
      ...
      children: [
        ...
        },
        {
          ...
          name: "LTV/CAC",
          short:
            "Соотношение LTV к CAC: сколько ценности вы получаете на каждый потраченный доллар.",
          why:
